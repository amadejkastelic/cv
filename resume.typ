...
#resume-item[
  ...
  - Maintaining and evolving shared Bazel rules and build infrastructure used across engineering teams.
]
...
#resume-item[
  - Developed Go microservices and APIs powering access-graph visualization and permission analysis across Access Intelligence, Access AI, and Access Hub.
  - Integrated with 300+ enterprise systems (AWS, Okta, Snowflake) to collect identity and entitlement data.
  - Built shared Bazel rules that standardized build and development workflows across engineering teams.
]
...
#resume-item[
  ...
  - Built a reusable Python/Terraform library that enabled teams to define standardized AWS infrastructure as code.
